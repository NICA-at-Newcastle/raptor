...
def split_text(
    ...
    n_tokens = [token_counter(" " + sentence) for sentence in sentences]
    ...
    for sentence, token_count in zip(sentences, n_tokens):
        ...
        if token_count > max_tokens:
            ...
            sub_token_counts = [token_counter(" " + sub_sentence) for sub_sentence in filtered_sub_sentences]
...
def get_node_list(
    ...
    if select_indices:
        node_list = [node_dict[index] for index in indices if node_dict[index]["index"] in select_indices]
    else:
